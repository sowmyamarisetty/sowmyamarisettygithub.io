...
var selectedColor = '#00e1ff';					//Color applied when mouse moves over a point
var storedColor = '#b3e01d';					//Saves original color for temporary changing
...
function resetGame(){
	...
	document.getElementsByClassName('alert2')[0].style.visibility = 'hidden';
	setBoard();
}
...
function playerWins(player){
	...
	document.getElementsByClassName('alert2')[0].style.visibility = 'visible';
	document.getElementsByClassName('alert1')[0].style.visibility = 'visible';
}
